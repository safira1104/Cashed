<x-layout>
    ...
    <style>
        ...
        .form-container {
            max-width: 400px; /* Atur lebar maksimal form untuk memperkecil ukuran form */
            margin: 0; /* Hapus margin untuk menempatkan form di kiri */
            padding: 20px;
        }
                ...
                <div class="card form-container">
                    <div class="card-body">
                        <form action="{{ route('supplier_orders.store') }}" method="post">
                            ...
                            <div class="d-flex justify-content-between"> <!-- Memindahkan tombol ke kiri -->
